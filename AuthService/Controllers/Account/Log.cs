...
public partial class AccountController
{
    ...
    ///       Typically used to communicate <i>significant events</i> such as application startup, successful operations, or key milestones.
    ///     </description>
    ///   </item>
    ///   <item>
    ///     <term><b>WARN</b></term>
    ...
    ///       Suggests that there might be a <i>problem</i> that needs to be addressed to prevent future errors or unexpected behavior.
    ///     </description>
    ///   </item>
    ///   <item>
    ///     <term><b>ERROR</b></term>
    ...
    ///       These messages indicate issues that need <i>investigation</i> and may impact the normal functioning of the application.
    ///     </description>
    ///   </item>
    ///   <item>
    ///     <term><b>FATAL</b></term>
    ///     <description>
    ///       The most <i>severe log level</i>, indicating a <i>critical error</i> that leads to the termination of the application or a major failure.
    ...
    {
        logger.Log(level, $"[{nameof(AccountController)}] {message}");
    }
}